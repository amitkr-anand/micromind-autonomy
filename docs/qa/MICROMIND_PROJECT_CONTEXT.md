...
| OI-38 | PX4-05 Checkpoint v1.2 schema implemented (fcb5106), SA-01–SA-04 PASS. EC-02 partially addressed — schema complete and serialisation verified. SA-05–SA-07 (reboot detection, D8a gate SA-05: cold-start vs reboot discriminator; SA-06: ESKF position integrity on restore; SA-07: D8a gate integration) pending Prompt 5. | Code | HIGH — SB-5 Phase A complete, Phase B gates pending |
