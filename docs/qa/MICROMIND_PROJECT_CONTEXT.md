...
| Repo | Purpose | State |
|---|---|---|
| `amitkr-anand/micromind-autonomy` | Main autonomy stack | Gates 1–7 LOCKED, 512/512 certified baseline, HEAD e7d3d42 (W2-2 — PLN-02 R-03 ETA snapshot/restore + RETASK_ROLLBACK, 24 Apr 2026) |
...
**Total regression baseline:** 512 tests. Run: bash run_certified_baseline.sh on both dev and Orin.
