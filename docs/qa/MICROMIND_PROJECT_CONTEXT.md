...
| HIL H-4 — LightGlue Subprocess IPC Bridge | ✅ COMPLETE | Unix socket bridge: server.py (hil-h3 Python 3.10) + client.py (Python 3.11). T1/T2/T3 PASS. IPC overhead 0.35 ms. Stub mode active on dev; real LightGlue (628 ms median, 45× margin) verified in H-3. Contract: docs/interfaces/L2_LIGHTGLUE_IPC.md. | `33c0d40` |
